...
func (m *DhDashboardGroup) OrderPager(page int64, page_size int64, filters map[string]interface{}, order ...string) (total int64, total_page int64, result []*DhDashboardGroup) {
	var list []*DhDashboardGroup
	total,total_page = m.pager(m, filters, page_size)
